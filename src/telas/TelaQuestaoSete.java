...
public class TelaQuestaoSete extends javax.swing.JFrame {

    AudioClip somFundo;

    public TelaQuestaoSete(AudioClip somFundo) {
        initComponents();
        this.somFundo = somFundo;
    }

    public TelaQuestaoSete() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("7)Resolver as subtrações: ");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/fundop3.jpg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 570, 460));

        setSize(new java.awt.Dimension(569, 441));
    ...
    private void btnResponderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResponderActionPerformed
        ...
        if (txtUm.getText().equals("3") || txtUm.getText().equals("Três") || txtUm.getText().equals("três")
                && txtDois.getText().equals("1") || txtDois.getText().equals("Um") || txtDois.getText().equals("um")
                && txtTres.getText().equals("6") || txtTres.getText().equals("Seis") || txtTres.getText().equals("seis")
                && txtQuatro.getText().equals("0") || txtQuatro.getText().equals("Zero") || txtQuatro.getText().equals("zero")) {
            JOptionPane.showMessageDialog(null, "<html><b>PARÁBENS, VOCÊ ACERTOU!</b></html>", "RESPOSTA CORRETA!", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "A resposta correta é:\n3\n1\n6\n0", "RESPOSTA ERRADA!", JOptionPane.ERROR_MESSAGE);
        }
        TelaQuestaoOito telaQuestaoOito = new TelaQuestaoOito(somFundo);
        telaQuestaoOito.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaQuestaoSete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaQuestaoSete().setVisible(true);
            }
        });
    }
